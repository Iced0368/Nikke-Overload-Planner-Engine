...
const inputPath = resolve(projectRoot, "wasm", "monteCarloPolicy.cpp");
const outputPath = resolve(projectRoot, "dist", "wasm-bench", "monteCarloPolicy.mjs");
...
const emccArgs = [
  ...
  "EXPORT_ALL=1",
  "-s",
  'EXPORTED_FUNCTIONS=["_malloc","_free","_run_policy_trials"]',
  "-o",
  outputPath,
];
...
console.log(`Built WASM benchmark module: ${outputPath}`);
