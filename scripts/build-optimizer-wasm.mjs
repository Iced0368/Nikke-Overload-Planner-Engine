...
const inputPath = resolve(projectRoot, "wasm", "optimizerCore.cpp");
const outputPath = resolve(projectRoot, "public", "wasm", "optimizerCore.mjs");
...
const emccArgs = [
  ...
  "EXPORT_ALL=1",
  "-s",
  'EXPORTED_FUNCTIONS=["_malloc","_free","_run_optimizer_core"]',
  "-o",
  outputPath,
];
...
console.log(`Built optimizer WASM module: ${outputPath}`);
